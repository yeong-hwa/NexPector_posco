...
<!-- location -->
<div class="locationBox"><div class="st_under"><h2>감시장비 서비스 관리</h2><span>Home &gt; 감시장비 관리 &gt; 감시장비 서비스 관리</span></div></div>
<!-- location // -->
...
<div class="manager_contBox1">
	...
	<div class="stitle1" style="float: none;">
		<div class="st_under">
			...
			<span>
				<a href="<c:url value='/admin/go_prgm.mon.service_info.insert.htm'/>" id="btn_save" class="css_btn_class">등록</a>
			</span>
		</div>
	</div>
	<!-- stitle // -->
...
<script type="text/javascript">
		...
		var dataSource = new kendo.data.DataSource({
			transport		: {
				read		: {
					...
					url 		: cst.contextPath() + "/admin/kendoPagination_service_info.select_list.htm",
					data 		: function(data) {
						return {
		...
		grid = $("#grid")
			.kendoGrid($.extend(kendoGridDefaultOpt, {
				...
				columns		: [
					...
					{field:'S_ALIAS', title:'서비스', width:'20%', attributes:{style:'text-align:center'}, headerAttributes:{style:'text-align:center;vertical-align:middle'}}
				]
			})).data('kendoGrid');
	}
	...
	function selectedRow(event) {
		...
		$('#frm')
			...
			.attr({'action' : cst.contextPath() + '/admin/go_prgm.mon.service_info.insert.htm'})
			.submit();
