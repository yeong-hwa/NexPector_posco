		            	...
		            	<table width="100%" height="100%">
		            		<tr valign="top">
		            			<td align="center" colspan="4">
		            				<chart:chart height="155" bgcolor="#FFFFFF" width="<%= (101 * svr_type.size()) + (303 - (101 * (svr_type.size() % 3))) %>" xmlpath="/component.all_chart_type.neonex?N_GROUP_CODE=${param.N_GROUP_CODE}"/>
		            			</td>
		            		</tr>
		            	</table>
		            </td>
