...
<chart>
	...
	<update url='<c:url value="/watcher/go_realtime_stats.component.lately_server_error.lately_month_server_error_chart.htm"/>?N_GROUP_CODE=${param.N_GROUP_CODE}&req_data=data;latelyMonthServerErrorQry' delay='7' />
