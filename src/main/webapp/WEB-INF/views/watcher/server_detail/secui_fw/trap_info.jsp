    ...
    $(function() {
        var dataSource = new kendo.data.DataSource({
            transport		: {
                read		: {
                    ...
                    url 		: cst.contextPath() + "/watcher/kendoPagination_SecuiFwTrapInfoLstQry.htm",
                    data 		: function(data) {
        ...
        $("#trapInfoGrid")
            .kendoGrid($.extend({}, kendoGridDefaultOpt, {
                ...
                dataBound	: function () {
                    var grid = $('#trapInfoGrid').data('kendoGrid');
                    $(grid.thead.find('th')).each(function () {
                        $(this).prop('title', $(this).data('title'));
                    });
                },
                scrollable	: true,
                columns		: columns.trapInfo()
            }));
    });
</script>
...
<div class="avaya_stitle1" style="float: none;">
    <div class="st_under"><h4>TRAP 정보</h4></div>
</div>
<!-- stitle // -->
<!-- table_typ2-3 -->
<div class="table_typ2-3" id="trapInfoGrid">
</div>
<!-- table_typ2-3 // -->