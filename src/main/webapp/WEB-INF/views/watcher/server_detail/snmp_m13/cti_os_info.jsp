...
<%
	String[][] head = {
		...
		, {"명칭", "20%", "S_SERVER_NAME"}
		, {"Peripheral 명칭", "20%", "S_PERIPHERAL_NAME"}
		, {"종류", "10%", "N_PERIPHERAL_TYPE_NAME"}
		, {"사이드 A 명칭", "10%", "S_CG_SIDEA_NAME"}
		, {"사이드 B 명칭", "10%", "S_CG_SIDEB_NAME"}
		, {"PEER", "10%", "S_PEER_NAME"}
	};
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="8"><img src="${img2}/icon_result.jpg" align="absmiddle" >CTI OS</td>
                    </tr>
                    <tr align="center">
