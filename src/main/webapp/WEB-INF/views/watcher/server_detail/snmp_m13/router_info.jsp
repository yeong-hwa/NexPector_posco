...
<%
	String[][] head = {
		...
		, {"사이드", "20%", "N_SIDE_NAME"}
		, {"초당 콜수", "10%", "N_CALLS_PER_SEC"}
		, {"로그온 수량", "10%", "N_AGENTS_LOGGED_ON"}
		, {"통화중 콜수", "10%", "N_CALLS_IN_PROGRESS"}
...
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="8"><img src="${img2}/icon_result.jpg" align="absmiddle" >Router</td>
                    </tr>
                    <tr align="center">
