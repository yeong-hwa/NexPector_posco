...
<%
	String[][] head = {
		...
		, {"아이디", "10%", "N_PIM_NUMBER"}
		, {"명칭", "20%", "S_PERIPHERAL_NAME"}
		, {"종류", "15%", "N_PERIPHERAL_TYPE_NAME"}
		, {"상태", "15%", "N_STATUS_NAME"}
		, {"호스트", "20%", "S_PERIPHERAL_HOST_NAME"}
	};
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="7"><img src="${img2}/icon_result.jpg" align="absmiddle" >PIM</td>
                    </tr>
                    <tr align="center">
