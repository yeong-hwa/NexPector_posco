...
<%
	String[][] head = {
		...
		, {"아이디", "10%", "N_CG_NUMBER"}
		, {"사이드", "20%", "N_SIDE_NAME"}
		, {"사이드 A 명칭", "15%", "S_PG_SIDEA_NAME"}
		, {"사이드 B 명칭", "15%", "S_PG_SIDEB_NAME"}
		, {"페어 이름", "20%", "S_DUPLEX_PAIR_NAME"}
	};
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="7"><img src="${img2}/icon_result.jpg" align="absmiddle" >CTI Gateway</td>
                    </tr>
                    <tr align="center">
                    ...
                    <c:choose>
                    	...
                    	<c:otherwise>
                    		<tr>
                    			<td height="25" align="center" class="line_gray text11" colspan="7">검색된 데이터가 없음</td>
                    		</tr>
                    	</c:otherwise>
                    </c:choose>
                    <tr>
