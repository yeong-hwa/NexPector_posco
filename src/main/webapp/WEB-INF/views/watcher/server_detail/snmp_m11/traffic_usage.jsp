...
<script>
	...
	function fn_dateChange(strDate)
	{
		...
		%>
				...
				frm.action = "<c:url value='/watcher/go_server_detail.snmp_m11.hour_history_chart_main.htm'/>?N_MON_ID=${param.N_MON_ID}&S_COLUMN=<%=key%>&OBJ_TOP=${205+(85*(1))}&OBJ_LEFT=200";
				frm.submit();
		<%  }
			ir = null;
		%>
	...
	function fn_dayChange(strDate)
	{
		...
		%>
				//<%=key%> <%=col_map.get(key)%>
				frm.target = "ifm_daily_chart_<%=key%>";
				frm.action = "<c:url value='/watcher/go_server_detail.snmp_m11.day_history_chart_main.htm'/>?N_MON_ID=${param.N_MON_ID}&S_COLUMN=<%=key%>&OBJ_TOP=${205+(85*(1))}&OBJ_LEFT=200";
				frm.submit();
		<%  }
			ir = null;
		%>
	...
	function fn_monthChange(strDate)
	{
		...
		%>
				//<%=key%> <%=col_map.get(key)%>
				frm.target = "ifm_daily_chart_<%=key%>";
				frm.action = "<c:url value='/watcher/go_server_detail.snmp_m11.month_history_chart_main.htm'/>?N_MON_ID=${param.N_MON_ID}&S_COLUMN=<%=key%>&OBJ_TOP=${205+(85*(1))}&OBJ_LEFT=200";
				frm.submit();
		<%  }
			ir = null;
		%>
...
<%--                       <cmb:combo qryname="qry_combo_m11_if" seltagname="N_IF_INDEX" param="N_MON_ID=${param.N_MON_ID}"/> --%>
                      <b>Interface List</b>
