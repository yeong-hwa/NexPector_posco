              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img onclick="javascript:fn_server_link('${svr_info.get(0).N_LINK_TYPE}','${svr_info.get(0).N_URL}')" src="${img2}/ico_vg2900.png">
                      </td>

                      <td width="70" class="text11 b gray">장비명</td>
                      <td width="307" height="33" background="${img2}/server_name3.jpg" class="pl10">
          ...
          <script>
          	$(function(){
          		...
          		$("#tab_menu .b").click(function() {
          			...
          			if($(this).children("input[name='tab_url']").val() == '<c:url value='/watcher/go_server_detail.snmp_m03.env_volt_info.htm?req_data=data;M03EnvVoltInfoLstQry|page_totalcnt;M03EnvVoltInfoLstCntQry'/>') frm_tab.pagecnt.value = '4';
          			else if($(this).children("input[name='tab_url']").val() == '<c:url value='/watcher/go_server_detail.snmp_m03.env_fan_info.htm?req_data=data;M03EnvFanInfoLstQry|page_totalcnt;M03EnvFanInfoLstCntQry'/>') frm_tab.pagecnt.value = '8';
          			else if($(this).children("input[name='tab_url']").val() == '<c:url value='/watcher/go_server_detail.snmp_m03.env_power_info.htm?req_data=data;M03EnvPowerInfoLstQry|page_totalcnt;M03EnvPowerInfoLstCntQry'/>') frm_tab.pagecnt.value = '4';
          			else if($(this).children("input[name='tab_url']").val() == '<c:url value='/watcher/go_server_detail.snmp_m03.env_temp_info.htm?req_data=data;M03EnvTempInfoLstQry|page_totalcnt;M03EnvTempInfoLstCntQry'/>') frm_tab.pagecnt.value = '4';
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="center" background="${img2}/tab_ce.jpg" style="padding:10px 0 10px 0">
                    ...
                    <tr align="center">
                      <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.snmp_m03_info.htm?req_data=data;SnmpM03InfoQry:map'/>"></td>
                      ...
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Interface<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.if_info.htm?req_data=data;M03IfInfoLstQry|page_totalcnt;M03IfInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">PRI Interface<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.pri_info.htm?req_data=data;M03IfInfoPRILstQry|page_totalcnt;M03IfInfoPRILstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">DSP<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.dsp_info.htm?req_data=data;M03DspInfoLstQry|page_totalcnt;M03DspInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">ISDN<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.isdn_info.htm?req_data=data;M03IsdnInfoLstQry|page_totalcnt;M03IsdnInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">VA Interface<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.vaif_info.htm?req_data=data;M03VaifInfoLstQry|page_totalcnt;M03VaifInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Volt<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.env_volt_info.htm?req_data=data;M03EnvVoltInfoLstQry|page_totalcnt;M03EnvVoltInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Temperature<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.env_temp_info.htm?req_data=data;M03EnvTempInfoLstQry|page_totalcnt;M03EnvTempInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Fan<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.env_fan_info.htm?req_data=data;M03EnvFanInfoLstQry|page_totalcnt;M03EnvFanInfoLstCntQry'/>"></td>
                    </tr>
                    <tr align="center">
                      <td height="33" valign="top" background="${img2}/tab_off2.png" class="b pt2">Power<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.env_power_info.htm?req_data=data;M03EnvPowerInfoLstQry|page_totalcnt;M03EnvPowerInfoLstCntQry'/>"></td>
                      <td valign="top" background="${img2}/tab_off2.png" class="b pt2">장애<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.error_stats.error_stats_main.htm'/>"></td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
