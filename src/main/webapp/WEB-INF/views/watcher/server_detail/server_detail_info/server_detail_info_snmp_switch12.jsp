              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img onclick="javascript:fn_server_link('${svr_info.get(0).N_LINK_TYPE}','${svr_info.get(0).N_URL}')" src="${img2}/ico_switch.png">
                      </td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="center" background="${img2}/tab_ce.jpg" style="padding:10px 0 10px 0">
                    ...
                    <tr align="center">
                      <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m12.snmp_m12_info.htm?req_data=data;SnmpM12InfoQry:map'/>"></td>
                      ...
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Interface<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m12.if_info.htm?req_data=data;M12IfInfoLstQry|page_totalcnt;M12IfInfoLstCntQry'/>"></td>
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Traffic<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m12.traffic_usage.htm?req_data=lst;qry_combo_m12_if'/>"></td>
