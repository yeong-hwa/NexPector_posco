		...
		<tr>
			...
			<td width="484" height="117" align="center" style="background-image:url(${img2}/bg_box05_01.png)">
				<table width="450" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="138" rowspan="3" align="center"><img onclick="javascript:fn_server_link('${svr_info.get(0).N_LINK_TYPE}','${svr_info.get(0).N_URL}')" src="${img2}/ico_system.png" /></td>
						<td width="87" align="left"><strong>장비명</strong></td>
						<td width="228" height="33" align="left" style="background-image:url(${img2}/server_name2_2.png); padding-left:10px;"><strong>${svr_info.S_MON_NAME}&nbsp;&nbsp;-&nbsp;&nbsp;[${svr_info.N_MON_ID}]</strong></td>
						<td width="31">&nbsp;</td>
					</tr>
					<tr>
						<td align="left"><strong>IP주소</strong></td>
						<td height="33" align="left" style="background-image:url(${img2}/server_name2_2.png); padding-left:10px;"><strong>${svr_info.S_MON_IP}</strong></td>
						<td height="33">&nbsp;</td>
					</tr>
					<tr>
						<td align="left"><strong>연결상태</strong></td>
						<td height="33" align="left" style="background-image:url(${img2}/server_name2_2.png); padding-left:10px;"><span style="font-weight:bold; color:#0033FF"><c:if test="${svr_info.B_CON_INFO == '연결'}"><b style="color:blue;">${svr_info.B_CON_INFO}</c:if><c:if test="${svr_info.B_CON_INFO == '연결안됨'}"><b style="color:red;">${svr_info.B_CON_INFO}</c:if></span></strong></td>
						<td height="33">&nbsp;</td>
					</tr>
				</table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<%
						...
						String[] tabKeys  = {"CNT_RESOURCE", "CNT_PROCESS", "CNT_SERVICE", "CNT_FAULT", "CNT_TRAP" };
						String[] tabNames = {
							...
							"TRAP<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/server_detail/secui_fw/trap_info.htm\">"
						};
