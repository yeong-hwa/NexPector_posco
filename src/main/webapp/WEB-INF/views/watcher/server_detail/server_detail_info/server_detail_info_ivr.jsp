...
<table height="100%" width="100%" style="background-repeat:no-repeat" class="pl54 pt34">
	<tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<%
									...
									String[] tabKeys  = {"CNT_RESOURCE", "CNT_PROCESS", "CNT_SERVICE", "CNT_ICMP", "CNT_ACCESS", "CNT_IVR_CHANNEL", "CNT_IVR_CHANNEL", "CNT_REC_CHANNEL", "CNT_REC_CHANNEL", "CNT_FAX_CHANNEL", "CNT_FAX_CHANNEL", "CNT_FAULT" };
									String[] tabNames = {
										...
										"IVR 정보<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.ivr_info.htm\">",
										"IVR 채널<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.ivr_channel.htm\">",
										"REC 정보<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.rec_info.htm\">",
										"REC 채널<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.rec_channel.htm\">",
										"FAX 정보<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.fax_info.htm\">",
										"FAX 채널<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.ivr_rec_fax.fax_channel.htm\">",
