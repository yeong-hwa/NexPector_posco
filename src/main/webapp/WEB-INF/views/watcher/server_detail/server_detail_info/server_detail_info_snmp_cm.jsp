        ...
        <tr>
         ...
         <div id="div_p_s_info">
          <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td bgcolor="e9e9e9">&nbsp;</td>
                <td height="96" bgcolor="e9e9e9"><!-- 장비 장애 현황 시작 -->
                ...
                <td align="center" background="${img2}/tab_ce.jpg" style="padding:10px 0 10px 0">
          		  <table border="0" cellspacing="0" cellpadding="0" id="tab_menu">
          		  	<c:if test="${svr_info.S_CM_TYPE == 'Call서버'}">
          		  		<tr align="center">
	                      <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.snmp_m02_info.htm?req_data=data;SnmpM02InfoQry:map'/>"></td>
                          ...
                          <!-- IBK
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">전화기<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.phone_info.htm'/>"></td>
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">내선<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.ext_info.htm'/>"></td>
                          -->
                          <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">IP전화기<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.phone_info.htm'/>"></td>
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">내선<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.ext_info.htm'/>"></td>
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">GateWay<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.gateway_info.htm?req_data=data;M02GatewayInfoLstQry|page_totalcnt;M02GatewayInfoLstCntQry'/>"></td>
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">H323<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.h323_info.htm?req_data=data;M02H323InfoLstQry|page_totalcnt;M02H323InfoLstCntQry'/>"></td>
	                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">SIP<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.sip_info.htm?req_data=data;M02SipInfoLstQry|page_totalcnt;M02SipInfoLstCntQry'/>"></td>
                    ...
                    <c:if test="${svr_info.S_CM_TYPE != 'Call서버' and svr_info.S_CM_TYPE != '기타'}"> <!-- not used. -->
                      <tr align="center">
                          <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m02.snmp_m02_info.htm?req_data=data;SnmpM02InfoQry:map'/>"></td>
                          <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">자원정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.resource_usage.resource_usage.htm?req_data=lst;ResourceLstQry'/>"></td>
                          <!-- IBK
