...
$(document).ready(function(){
	...
	$.ajax({
		url:'<c:url value="/watcher/server_detail/accrue_chart_M07TrafficUsageQry.htm"/>',
        type:"post",
        data:{N_MON_ID : $('#N_MON_ID').val(), N_INDEX : $('#N_INDEX').val(), S_COLUMN : $('#S_COLUMN').val(), N_DAY : $('#N_DAY').val()},
        dataType : "text",
...
<input type="hidden" id="N_INDEX" name="N_INDEX" value="${param.N_INDEX}" />
