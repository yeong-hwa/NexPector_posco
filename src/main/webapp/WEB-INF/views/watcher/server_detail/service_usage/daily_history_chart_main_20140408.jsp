...
<script language="javascript" type="text/javascript" src="<c:url value="/common/js"/>/jqplot/dist/plugins/jqplot.canvasTextRenderer.min.js"></script>
<script language="javascript" type="text/javascript" src="<c:url value="/common/js"/>/jqplot/dist/plugins/jqplot.canvasAxisLabelRenderer.min.js"></script>
...
function popChart(){
	//window.open("${contextPath}/prgm/server_detail/service_usage/daily_history_chart.jsp?N_MON_ID=${param.N_MON_ID}&S_MAP_KEY=${param.S_MAP_KEY}&N_DAY=${param.N_DAY}","setting","width=800, height=400, location=no", true);
