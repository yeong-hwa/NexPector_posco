...
<script>
	...
	{		
		...
		frm.action = "<c:url value='/watcher/go_server_detail.ivr_channel.daily_history_chart_main.htm'/>?N_MON_ID=${param.N_MON_ID}&OBJ_TOP=${205+(85)}&OBJ_LEFT=200";
		frm.submit();
	}
                	    		...
                	    		$.getJSON("<c:url value='/watcher/lst_RealProcessServiceUsageQry3.htm'/>", param, function(data){
		                          ...
		                          <tr>
		                          	<td height="20" class="b"><img src="${img2}/icon_result.jpg" align="absmiddle">상태별 Peak 
		                          		[<span style="color:#FF0000;font-weight:bold;">Off</span>
		                          		<span style="color:#00FF00;font-weight:bold;">Wait</span>
		                          		<span style="color:#0000FF;font-weight:bold;">Ring</span>
		                          		<span style="color:#FFFF00;font-weight:bold;">Connect</span>
		                          		<span style="color:#00FFFF;font-weight:bold;">Unknown</span>]
		                          	</td>
