                	    		...
                	    		$.getJSON("<c:url value='/watcher/lst_RealProcessServiceUsageQry3.htm'/>", param, function(data){
		                          ...
		                          <tr>
		                          	<td height="20" class="b"><img src="${img2}/icon_result.jpg" align="absmiddle">상태별 Peak 
		                          		[<span style="color:#FF0000;font-weight:bold;">Send</span>
		                          		<span style="color:#00FF00;font-weight:bold;">Recv</span>
		                          		<span style="color:#0000FF;font-weight:bold;">Wait</span>
		                          		<span style="color:#FFFF00;font-weight:bold;">Off</span>]
		                          	</td>
