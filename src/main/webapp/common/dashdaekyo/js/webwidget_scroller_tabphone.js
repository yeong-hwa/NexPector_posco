...
(function(a){
a.fn.webwidget_scroller_tabphone=function(p){
    var p=p||{};

    var s_t_i=p&&p.scroller_time_interval?p.scroller_time_interval:"5000";
    var s_w_p=p&&p.scroller_window_padding?p.scroller_window_padding:"10";
    var s_w_w=p&&p.scroller_window_width?p.scroller_window_width:"920";
    var s_w_h=p&&p.scroller_window_height?p.scroller_window_height:"32";
...
//    var d=p&&p.directory?p.directory:"images";
    var dom=a(this);
    var s_length=dom.children(".tabBodyphone").children("ul").children("li").length;
    var timer;
    var current = 0;
    var li_width;
    s_w_p += "px";
    ...
    function begin(){
     ...
     //   dom.children(".tabBodyphone").width(parseInt(s_w_w)-2);
    //    dom.children(".tabBodyphone").height(parseInt(s_w_h)-28-4);
   //     dom.children(".tabBodyphone").children("ul").width((parseInt(s_w_w)-2)*s_length);
  //      dom.children(".tabBodyphone").children("ul").height(parseInt(s_w_h)-28-4);
 //       dom.children(".tabBodyphone").children("ul").children("li").width(parseInt(s_w_w)-2);
//        dom.children(".tabBodyphone").children("ul").children("li").height(parseInt(s_w_h)-28-4);
//        dom.children(".tabBody").children("ul").children("li").children("p").css("padding",s_w_p);
    ...
    function play(){
        ...
        dom.children(".tabBodyphone").children("ul").animate({
            left:to_location
        },500);
        dom.children(".tabContainer").children(".tabHead").children("li").children("a").css("color",s_h_t_c);
