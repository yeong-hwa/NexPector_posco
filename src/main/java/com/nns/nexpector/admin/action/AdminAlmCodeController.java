 ...
 */
@Controller
@RequestMapping("/admin/almCodeInfo/")
public class AdminAlmCodeController {
    ...
    public View insert(@RequestParam Map params) throws Exception {
        ...
        try {
                service.getInsData("alm_code_info.insert_data", params);
        } catch(Exception e) {
    ...
    public View update(@RequestParam Map params) throws Exception {
        ...
        try {
                service.getUpdData("alm_code_info.update_data", params);
        } catch(Exception e) {
    ...
    public View delete(@RequestParam Map params) throws Exception {
        ...
        try {
                service.getDelData("alm_code_info.delete_data", params);
        } catch(Exception e) {
            logger.error(e.getMessage());
            throw e;
        }
