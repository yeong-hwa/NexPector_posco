(function(a){
    a.fn.webwidget_scroller_tab=function(p){
        ...
        var s_t_i=p&&p.scroller_time_interval?p.scroller_time_interval:"2000";
        var s_w_p=p&&p.scroller_window_padding?p.scroller_window_padding:"10";
        var s_w_w=p&&p.scroller_window_width?p.scroller_window_width:"740";
        var s_w_h=p&&p.scroller_window_height?p.scroller_window_height:"127";
