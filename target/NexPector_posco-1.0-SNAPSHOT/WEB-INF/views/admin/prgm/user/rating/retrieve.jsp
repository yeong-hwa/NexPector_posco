...
<%--해당 화면의 url --%>
<c:set var="app_url"><c:url value='/admin/go_prgm.user.rating'/></c:set>
<c:set var="app_nm" value="rating"/>

<%--해당 화면의 제목 --%>
<c:set var="app_title_name" value="사용자등급코드 관리"/>

<script>
	<%-- 데이터의 키 값(Update 및 상세 조회시 사용할 Key 값 여러개일경우 세미콜론(;) 으로 구분 --%>
	var v_key_col = "N_RAT_CODE";
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" id="search_data">
              <tr>
                <td height="45" align="center" class="box">
                	...
                	등급명 <input type="text" name="S_RAT_NAME" id="S_RAT_NAME" value="${param.S_RAT_NAME}" class="input_search" id="textfield1" style="width:90px;height:20px;">
                	</span>
