...
<form id="frm_threshold" method="post">
	<table id="table_threshold" summary="" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td class="filed_A" colspan="5">임계치 설정</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="filed_B">
				<input type="text" name="N_VALUE_A" id="start_value" value="${data.N_VALUE_A}" class="int_f" style="width:30px;ime-mode:disabled;" onContextMenu="return false;"/> ~
				<input type="text" name="N_VALUE_B" id="end_value" value="${data.N_VALUE_B}" class="int_f" style="width:30px;ime-mode:disabled;" onContextMenu="return false;"/>
			</td>
			<td class="filed_B">
				<input type="text" name="N_THRESHOLD" id="threshold" value="${data.N_THRESHOLD}" class="int_f" style="width:30px;ime-mode:disabled;" onContextMenu="return false;"/>
			</td>
			<td class="filed_B">
				<select name="N_USE">
