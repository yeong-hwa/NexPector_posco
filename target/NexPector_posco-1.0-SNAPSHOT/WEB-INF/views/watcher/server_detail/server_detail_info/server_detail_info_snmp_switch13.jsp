        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                String[] tabKeys  = {"CNT_M13_GENERAL_INFO", "CNT_M13_RESOURCE", "CNT_M13_COMPONENT", "CNT_M13_CPNT_ELEMENT", "CNT_M13_ROUTER", "CNT_M13_NIC", "CNT_M13_LOGGER", "CNT_M13_DIST_AW", "CNT_M13_PERIPHERAL_GW", "CNT_M13_PIM", "CNT_M13_CTI_GATEWAY", "CNT_M13_CTI_OS", "CNT_M13_ALM"};
                String[] tabNames = {
                	"기본정보<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.snmp_m13_info.htm?req_data=data;SnmpM13InfoQry:map\">",
                    "자원정보<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.resource_usage.resource_usage.htm?req_data=lst;ResourceLstQry\">",
                    "Component<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.component_info.htm?req_data=data;M13ComponentInfoLstQry|page_totalcnt;M13ComponentInfoLstCntQry\">",
                    "Element<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.element_info.htm?req_data=data;M13ElementInfoLstQry|page_totalcnt;M13ElementInfoLstCntQry\">",
                    "Router<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.router_info.htm?req_data=data;M13RouterInfoLstQry|page_totalcnt;M13RouterInfoLstCntQry\">",
                    "NIC<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.nic_info.htm?req_data=data;M13NICInfoLstQry|page_totalcnt;M13NICInfoLstCntQry\">",
                    "Logger<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.logger_info.htm?req_data=data;M13LoggerInfoLstQry|page_totalcnt;M13LoggerInfoLstCntQry\">",
                    "Distributor AW<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.distributor_aw_info.htm?req_data=data;M13DistributorAWInfoLstQry|page_totalcnt;M13DistributorAWInfoLstCntQry\">",
                    "Peripheral GW<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.peripheral_gw_info.htm?req_data=data;M13PeripheralGWInfoLstQry|page_totalcnt;M13PeripheralGWInfoLstCntQry\">",
                    "PIM<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.pim_info.htm?req_data=data;M13PIMInfoLstQry|page_totalcnt;M13PIMInfoLstCntQry\">",
                    "CTI Gateway<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.cti_gw_info.htm?req_data=data;M13CtiGWInfoLstQry|page_totalcnt;M13CtiGWInfoLstCntQry\">",
                    "CTI OS<input type=\"hidden\" name=\"tab_url\" value=\"" + contextPath + "/watcher/go_server_detail.snmp_m13.cti_os_info.htm?req_data=data;M13CtiOSInfoLstQry|page_totalcnt;M13CtiOSInfoLstCntQry\">",
