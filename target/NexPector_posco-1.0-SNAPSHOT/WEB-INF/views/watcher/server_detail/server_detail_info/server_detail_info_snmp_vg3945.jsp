              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img onclick="javascript:fn_server_link('${svr_info.get(0).N_LINK_TYPE}','${svr_info.get(0).N_URL}')" src="${img2}/ico_vg3945.png">
                      </td>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="center" background="${img2}/tab_ce.jpg" style="padding:10px 0 10px 0">
                    ...
                    <tr align="center">
                      <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.snmp_m03_info_vg3945.htm?req_data=data;SnmpM03InfoQry:map'/>"></td>
                      ...
                      <td width="106" valign="top" background="${img2}/tab_off2.png" class="b pt2">Power<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.env_power_info.htm?req_data=data;M03EnvPowerInfoLstQry|page_totalcnt;M03EnvPowerInfoLstCntQry'/>"></td>
                    </tr>
                    <tr align="center">
                      <td height="33" valign="top" background="${img2}/tab_off2.png" class="b pt2">장애<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.error_stats.error_stats_main.htm'/>"></td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
                      <td valign="top">&nbsp;</td>
