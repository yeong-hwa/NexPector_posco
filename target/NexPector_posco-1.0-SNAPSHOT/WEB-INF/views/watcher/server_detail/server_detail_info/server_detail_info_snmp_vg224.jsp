              ...
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <img onclick="javascript:fn_server_link('${svr_info.get(0).N_LINK_TYPE}','${svr_info.get(0).N_URL}')" src="${img2}/ico_vg224.png">
                      </td>
          ...
          <script>
          	$(function(){
          		...
          		$("#tab_menu .b").click(function() {
          			...
          			if($(this).children("input[name='tab_url']").val() == 'server_detail.vaif_info.neonex')
          			{
          				$("form[name='frm_tab']").append("<input type='hidden' name='vg_kind' value='VG224'>");
          			}
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td align="center" background="${img2}/tab_ce.jpg" style="padding:10px 0 10px 0">
                    ...
                    <tr align="center">
                      <td width="106" height="33" valign="top" background="${img2}/tab_on2.png" class="b white pt2">장비정보<input type="hidden" name="tab_url" value="<c:url value='/watcher/go_server_detail.snmp_m03.snmp_m03_info_vg224.htm?req_data=data;SnmpM03InfoQry:map'/>"></td>
