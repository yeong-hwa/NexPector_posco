	...
	<%@ include file="/WEB-INF/views/include/ListHeadClick.jsp"%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr align="center">
                      ...
                      <td width="10%" background="${img}/table_title.jpg" class="b text11 gray"><thead:thead col="S_NAME" name="장비명" reqcol="${param.order_id}" ascdescstring="${asc_desc_String}" sort="${param.asc_desc}"/></td>
                      ...
                      <td width="10%" background="${img}/table_title.jpg" class="b text11 gray"><thead:thead col="S_INET_ADDR" name="IP주소" reqcol="${param.order_id}" ascdescstring="${asc_desc_String}" sort="${param.asc_desc}"/></td>
                      ...
                      <td width="10%" background="${img}/table_title.jpg" class="b text11 gray"><thead:thead col="S_STATUS_REASON" name="현재상태" reqcol="${param.order_id}" ascdescstring="${asc_desc_String}" sort="${param.asc_desc}"/></td>
                    </tr>
