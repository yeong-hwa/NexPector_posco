...
$(document).ready(function(){
	$.ajax({
		url:'<c:url value="/watcher/server_detail/accrue_chart_AccrueProcessUsageQry.htm"/>',
        type:"post",
...
function popChart(){
	window.open("<c:url value='/watcher/go_server_detail.process_usage.daily_history_chart.htm'/>?N_MON_ID=${param.N_MON_ID}&S_MAP_KEY=${param.S_MAP_KEY}&N_DAY=${param.N_DAY}","blow_chart","width=900, height=430, location=no", true);
}
