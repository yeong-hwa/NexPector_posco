...
<%
	String[][] head = {
		{"인스턴스 번호", "7%", "N_INSTANCE_NUM"}
		, {"컴포넌트 번호", "7%", "N_CPNT_INDEX"}
		, {"사이드", "5%", "N_SIDE_NAME"}
		, {"종류", "5%", "N_TYPE_NAME"}
		, {"어드민 사이트", "7%", "S_ADMIN_SITE_NAME"}
		, {"라우터 사이드 A", "7%", "S_ROUTER_SIDEA_NAME"}
		, {"라우터 사이드 B", "7%", "S_ROUTER_SIDEB_NAME"}
		, {"로거 사이드 A", "7%", "S_LOGGER_SIDEA_NAME"}
		, {"로거 사이드 B", "7%", "S_LOGGER_SIDEB_NAME"}
		, {"페어 이름", "5%", "S_DUPLEX_PAIR_NAME"}
		, {"HDS 지원여부", "8%", "N_HDS_ENABLED"}
		, {"웹뷰 지원여부", "7%", "N_WEB_VIEW_ENABLED"}
		, {"웹뷰 서버 이름", "7%", "N_WEB_VIEW_SERVER_NAME"}
	};
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="13"><img src="${img2}/icon_result.jpg" align="absmiddle" >Distributor AW</td>
                    </tr>
                    <tr align="center">
