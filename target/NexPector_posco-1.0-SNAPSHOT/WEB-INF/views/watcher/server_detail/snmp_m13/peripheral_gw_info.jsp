...
<%
	String[][] head = {
		...
		, {"아이디", "10%", "N_PG_NUMBER"}
		, {"사이드", "20%", "N_SIDE_NAME"}
		, {"사이드 A 명칭", "10%", "S_ROUTER_SIDEA_NAME"}
		, {"사이드 B 명칭", "10%", "S_ROUTER_SIDEB_NAME"}
		, {"페어 이름", "20%", "S_DUPLEX_PAIR_NAME"}
		, {"PIM 수량", "10%", "N_PIM_COUNT"}
	};
%>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="b gray_sub" width="100%" height="50" colspan="8"><img src="${img2}/icon_result.jpg" align="absmiddle" >Peripheral GW</td>
                    </tr>
                    <tr align="center">
