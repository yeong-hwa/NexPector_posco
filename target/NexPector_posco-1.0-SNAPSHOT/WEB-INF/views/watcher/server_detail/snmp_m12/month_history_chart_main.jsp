...
$(document).ready(function(){
	...
	$.ajax({
		url:'<c:url value="/watcher/server_detail/accrue_chart_M12TrafficUsageMonthQry.htm"/>',
        type:"post",
        data:{N_MON_ID : $('#N_MON_ID').val(), N_IF_INDEX : $('#N_IF_INDEX').val(), S_COLUMN : $('#S_COLUMN').val(), N_YEAR : $('#N_YEAR').val()},
        dataType : "text",
...
<input type="hidden" id="N_YEAR" name="N_YEAR" value="${param.N_YEAR}" />
