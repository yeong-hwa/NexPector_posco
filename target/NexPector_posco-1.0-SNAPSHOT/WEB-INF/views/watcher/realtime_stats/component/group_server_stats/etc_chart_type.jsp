...
<chart>
	...
	<chart_rect x='0' y='35' width='55' height='40' />
	
	<chart_type>donut</chart_type>

	<draw>
		<text x='0' y='31' bold='true' shadow='high' color='111111' size='10'><%=all_cnt%></text>
		<text x='<%=conn_cnt>=10?(conn_cnt>=100?"15":"18"):"22"%>' y='45' bold='true' shadow='high' color='FDB233' size='<%=(conn_cnt>=100?"12":"14")%>'><%=conn_cnt%></text>
		<% if(alm_cnt > 0) {%><circle x='27' y='54' radius='12' layer='background' fill_color='ff0000' transition='none'></circle><%}%>
	</draw>
	<filter>
	...
	<update url='${contextPath}/component.group_server_chart2_type.neonex?N_GROUP_CODE=${param.N_GROUP_CODE}&N_TYPE_CODE=${param.N_TYPE_CODE}' delay='1' />
