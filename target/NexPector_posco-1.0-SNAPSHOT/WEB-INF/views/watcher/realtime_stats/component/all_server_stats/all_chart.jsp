...
<chart>
	...
	<c:forEach items="${svr_style}" var="m2" varStatus="vt">
		<image url='<c:url value="/common/charts/charts.swf"/>?library_path=<c:url value="/common/charts/charts_library"/>&xml_source=<c:url value="/watcher/go_realtime_stats.component.all_server_stats.etc_chart.htm"/>?N_GROUP_CODE%3D${param.N_GROUP_CODE}%26N_STYLE_CODE=${m2.CODE}%26S_TYPE_NAME=${m2.VAL}%26NUM=${vt.index}%26req_data=data;serverStatusQry|svr_style;compo_svr_style|svr_type;compo_svr_type' />
	</c:forEach>
	</draw>
	<filter>
	...
	<update url='<c:url value="/watcher/go_realtime_stats.component.all_server_stats.all_chart.htm"/>?N_GROUP_CODE=${param.N_GROUP_CODE}&req_data=data;serverStatusQry|svr_style;compo_svr_style|svr_type;compo_svr_type' delay='15' />
