		            	...
		            	<table width="100%" height="100%">
		            		<tr valign="top">
		            			<td align="center" colspan="4">
		            				<chart:chart height="155" bgcolor="#FFFFFF" width="${(101 * svr_style.size()) + (303 - (101 * (svr_style.size() % 3)))}" xmlpath="/watcher/go_realtime_stats.component.all_server_stats.all_chart.htm?N_GROUP_CODE=${param.N_GROUP_CODE}%26req_data=data;serverStatusQry|svr_style;compo_svr_style|svr_type;compo_svr_type"/>
		            			</td>
		            		</tr>
		            	</table>
		            </td>
