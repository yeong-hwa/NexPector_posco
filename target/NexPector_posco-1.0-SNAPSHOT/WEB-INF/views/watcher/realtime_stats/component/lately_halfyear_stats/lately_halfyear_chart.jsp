...
<chart>
	...
	<legend shadow='' x='25' y='0' width='285' height='20' margin='5' fill_color='000066' fill_alpha='8' line_alpha='0' line_thickness='0' size='12' color='333355' alpha='90' />
	...
	<update url='<c:url value="/watcher/go_realtime_stats.component.lately_halfyear_stats.lately_halfyear_chart.htm?N_GROUP_CODE=${param.N_GROUP_CODE}&req_data=data;latelyHalfyearStatsQry"/>' delay='15' />
